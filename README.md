**How to run game and get results GUIDE:**

cd "GemMine_Unity_code_2025-08-05\GemMine_Unity_code_2025-08-05"
python -u tools\serve_webgl_data.py --host 127.0.0.1 --port 8000 --build-dir WebGL_Build --data-root data

Game is running you may now:
http://127.0.0.1:8000/

Play game as game is playing backend python script records results: 
