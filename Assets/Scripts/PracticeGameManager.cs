...
class PracticeGameManager : GameManager {
    ...
    private Dictionary<string, string> tutorial = new Dictionary<string, string>
    {
        ...
        {"instruct pickup items", "Each round begins here in the mine base. First, you will have 30 seconds to search for " + (pickupSystemEnabled ? "and pickup " : "") + "one or more items that appear on the ground in the mine ('Search' trials). Try to remember where each item is, as you will need to return there later.\n\nAfter 30 seconds, the item(s) will disappear, and you will be asked to go back to the base. We recommend creating a story out of the items to help remember them in order. For example, if the items you see are a dog and Homer Simpson, imagine seeing the dog and Homer Simpson walks over to pick her up."},
