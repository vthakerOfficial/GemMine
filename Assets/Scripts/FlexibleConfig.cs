...
public class FlexibleConfig {
    public static JObject LoadFromText(string json) {
    ...
    public static void WriteToText(object data, string filename) {
        ...
        Debug.LogWarning("WriteToText: file writing is not supported in WebGL builds.");
#else
    ...
    public static Dictionary<string, object> CastToStatic(JObject cfg) {
