...
public class ControlPlayer : MonoBehaviour
{
	...
	void Update()
    {
        ...
        {
            im.scriptedInput.ReportScriptedEvent("playerTransform", new Dictionary<string, object> { 
    ...
    public void Respawn() 
    {
        ...
        im.scriptedInput.ReportScriptedEvent("playerRespawnTransform", new Dictionary<string, object> {
                {"positionX", gameObject.transform.position.x},
                {"positionZ", gameObject.transform.position.z},
                {"rotationY", gameObject.transform.rotation.eulerAngles.y},
                {"playerAtBase", true}});
